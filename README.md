...
I want to be a wholesome scientist in that I can actually do the lab work but most importantly test my hypothesis in-silico. That before I do PCR in the lab i can actually design and optmize my primers in-silico. The options of bioinformatics are limtless this is why I chose bioinformatics because i can solve problems that haven't been considered in the wet-lab or rather have been limitted in the wet-lab. More to this I think partly because bioinformatics is not monotonous you get innovative ways to solve different biological problems wih very unique tools and algorithims.
 ...
 *LONG TERM VISION OR GOAL*
 ...
 My longterm goal is to use bioinformatics for machine learning, drug design and drug prediction. I hope that i will be well vast in coding so as to come up with algorithims tailored for specific research questions .
...
- Understand different analysis tools, their uses, principles and limitations
- Understand LINUX and the UNIX command line
- Understand GIT and how to use effortlessly and effectively
